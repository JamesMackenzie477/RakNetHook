#include <Windows.h>
// Contains all of the RakNet class definitons.

namespace RakNet
{
	// Defines the RakNet peer interface class.
	// This is a low level class used by RakNet to interface with clients and servers.
	class RakPeerInterface
	{
	public:
		virtual ~RakPeerInterface();

		virtual VOID Startup(unsigned int maxConnections, SocketDescriptor *socketDescriptors, unsigned socketDescriptorCount, int threadPriority = -99999) = 0;
